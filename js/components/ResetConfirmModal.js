...
const ResetConfirmModal = ({
  ...
  title: a = "Reset Tool?",
  message:
    r = "This will reset all configurations to their default values. This action cannot be undone.",
}) =>
  e
    ? _jsx("div", {
          ...
          children: [
            _jsxs("div", {
              ...
              children: [
                _jsx("div", {
                  className:
                    "h-24 bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700",
