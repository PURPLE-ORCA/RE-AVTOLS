function ConduitCalculator() {
  const [e, t] = useState(4),
    ...
    g = [
      ...
      {
        type: "Fiber 12-Strand",
        category: "Fiber",
        diameter: 0.28,
        nec: "NEC 770",
      },
      {
        type: "Fiber 24-Strand",
        category: "Fiber",
        diameter: 0.35,
        nec: "NEC 770",
      },
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsx("div", {
        className:
          "bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 mb-6 border border-gray-200 dark:border-gray-700",
        children: _jsxs("p", {
      ...
      "mixed" === x &&
        _jsxs("div", {
          className:
            "bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-6 mb-6 border",
          children: [
            _jsx("h2", {
            ...
            _jsx("p", {
              ...
              children:
                "Select cable types from the NEC/AVIXA database or add custom cables:",
            }),
            _jsxs("div", {
              className:
              ...
              children: [
                _jsx("h3", {
                  className:
                    "font-semibold text-blue-800 dark:text-blue-200 mb-3",
                  children: "Add Cable",
                }),
                _jsxs("div", {
                ...
                "custom" === y &&
                  _jsxs("div", {
                    className:
                      "mt-4 p-3 bg-white dark:bg-gray-800 rounded-lg border",
                    children: [
                      _jsx("h4", {
                        className:
                        ...
                        children: [
                          _jsxs("div", {
                            children: [
                              _jsx("label", {
                                className:
                                  "block text-xs text-gray-600 dark:text-gray-300 mb-1",
                                children: "Cable Name",
                              }),
                              _jsx("input", {
                                type: "text",
                                ...
                                className:
                                  "w-full px-2 py-1 text-sm border rounded dark:bg-gray-700 dark:text-white dark:border-gray-600",
                              }),
                            ],
                          }),
                          _jsxs("div", {
                              ...
                              children: [
                                ...
                                _jsx("button", {
                                  ...
                                  onClick: () => {
                                    return (
                                      (e = t),
                                      void f(b.filter((t, s) => s !== e))
                                    );
                                    var e;
                                  },
                                  className:
                                    "text-red-600 hover:text-red-800 dark:text-red-200 px-2",
                                  children: "✕",
                                }),
                              ],
                            }),
            ...
            _jsx("button", {
              ...
              onClick: () => {
                if (0 === b.length)
                  return void alert("Please add at least one cable type");
        ...
        _jsxs(_Fragment, {
          children: [
            R.exceedsMaximum &&
              _jsxs("div", {
                className:
                  "bg-red-50 dark:bg-red-900/20 rounded-xl shadow-md dark:shadow-gray-950/20 p-6 mb-6 border-2 border-red-300",
                children: [
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsx("h2", {
                        className:
                          "text-xl font-bold text-red-800 dark:text-red-200",
                            ...
                            _jsxs(
                              "div",
                              {
                                ...
                                children: [
                                  ...
                                  _jsxs("div", {
                                    className:
                                      "text-sm text-gray-600 dark:text-gray-300 space-y-1",
                                    children: [
                                      _jsxs("div", {
                                        children: [
                                          "Cables per conduit: ~",
                  ...
                  R.bestPractices &&
                    ...
                    _jsxs("div", {
                      className:
                        "mt-4 p-3 bg-white dark:bg-gray-800 rounded-lg",
                      children: [
                        _jsx("h4", {
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsxs("div", {
                          className:
                            "text-3xl font-bold " +
                            (R.recommendedConduit.actualFillPercent <=
            ...
            !R.exceedsMaximum &&
              _jsxs("div", {
                className:
                  "bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-4 sm:p-6 mb-6 border",
                children: [
                  _jsx("h2", {
                    className:
                      "text-lg sm:text-xl font-semibold text-gray-800 mb-2",
                    ...
                    children: [
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          R.conduitOptions[A]?.trade ===
                            R.recommendedConduit.trade &&
                            _jsx("span", {
                              className:
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("span", {
                            className:
                              "text-xs text-gray-500 dark:text-gray-400 self-center",
                            children: "Quick Select:",
                          }),
                          R.conduitOptions.slice(0, 6).map((e, t) =>
                            _jsxs(
                              "button",
                              {
                                type: "button",
                    ...
                    children: [
                      _jsxs("div", {
                        ...
                        children: [
                          _jsxs("div", {
                            className:
                              "text-center p-3 bg-white dark:bg-gray-800 rounded-lg border",
                            children: [
                              _jsx("div", {
                                className:
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              ...
                              _jsx("div", {
                                ...
                                children:
                                  R.conduitOptions[A]?.jamStatus || "N/A",
                              }),
                              _jsx("div", {
                                className: "text-xs text-gray-400",
                                children:
            ...
            !R.exceedsMaximum &&
              ...
              _jsxs("div", {
                className:
                  "bg-amber-50 dark:bg-amber-900/20 rounded-xl shadow-md dark:shadow-gray-950/20 p-4 sm:p-6 mb-6 border border-amber-300",
                children: [
                  _jsxs("h2", {
                    className:
                    ...
                    return (
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsxs("p", {
                            className:
                              "text-sm text-amber-800 dark:text-amber-200 mb-2",
                            children: [
                              "Upgrade to ",
            ...
            _jsxs("div", {
              className:
                "bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 sm:p-5 mb-6 border border-blue-200 dark:border-blue-800",
              children: [
                _jsx("h2", {
                  className:
                    "text-base sm:text-lg font-semibold text-blue-800 dark:text-blue-200 mb-2 sm:mb-3",
                ...
                _jsx("div", {
                  className:
                    "bg-white dark:bg-gray-800 rounded-lg p-3 border border-blue-200 dark:border-blue-800 mb-3",
                  children: _jsxs("p", {
                    className:
                      "text-xs sm:text-sm font-mono text-blue-800 dark:text-blue-200 mb-1",
                    children: [
                ...
                _jsxs("div", {
                  ...
                  children: [
                    _jsxs("div", {
                      className:
                        "bg-red-50 dark:bg-red-900/20 p-2 rounded border border-red-200 dark:border-red-800 text-center",
                      children: [
                        _jsx("div", {
                    ...
                    _jsxs("div", {
                      className:
                        "bg-yellow-50 dark:bg-yellow-900/20 p-2 rounded border border-yellow-200 dark:border-yellow-800 text-center",
                      children: [
                        _jsx("div", {
                    ...
                    _jsxs("div", {
                      className:
                        "bg-green-50 dark:bg-green-900/20 p-2 rounded border border-green-200 dark:border-green-800 text-center",
                      children: [
                        _jsx("div", {
      ...
      "single" === x &&
        _jsxs("div", {
          className:
            "bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-4 sm:p-8 mb-6 sm:mb-8 border",
          children: [
            _jsx("h2", {
                  ...
                  children: [
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx("span", {
                          className:
                            "text-sm text-gray-500 dark:text-gray-400 self-center",
                          children: "cables",
                        }),
                      ],
                    }),
                    ...
                    _jsx("p", {
                      ...
                      children:
                        "Use slider for quick select or type any number (1-100)",
                    }),
                  ],
                }),
                _jsxs("div", {
            ...
            _jsx("button", {
              ...
              onClick: () => {
                ...
                if ((n(t), t._0xd93e1a)) {
                  const e = t._0xf639dc.findIndex(
                    (e) => e.trade === t._0xd93e1a.trade,
                  );
                  (d(e), I(e, t));
                } else (d(null), m(null));
              },
        ...
        _jsxs("div", {
          ...
          children: [
            i.exceedsMaximum &&
              _jsxs("div", {
                className:
                  "bg-red-50 dark:bg-red-900/20 rounded-xl shadow-md dark:shadow-gray-950/20 p-4 sm:p-6 border-2 border-red-300",
                children: [
                  _jsxs("div", {
                    className: "flex items-center gap-2 mb-3",
                    children: [
                      ...
                      _jsx("h2", {
                        className:
                          "text-lg sm:text-xl font-bold text-red-800 dark:text-red-200",
                        children: "Exceeds Maximum Single Conduit Capacity",
                      }),
                    ],
                  }),
            ...
            _jsxs("div", {
              className:
                "bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-4 sm:p-6 border",
              children: [
                _jsxs("div", {
                  className: "mb-4",
                  children: _jsx("h2", {
                ...
                _jsxs("div", {
                  className:
                    "grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6",
                  children: [
                    _jsxs("div", {
                      ...
                      className: i.exceedsMaximum
                        ...
                        : `p-4 sm:p-5 rounded-lg border-2 ${((e) => {
                            const t = {
                              ...
                              yellow:
                                "bg-yellow-100 border-yellow-300 text-yellow-800 dark:text-yellow-200",
                              green:
                                "bg-green-100 border-green-300 text-green-800 dark:text-green-200",
                ...
                _jsx("div", {
                  className:
                    "p-3 sm:p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg text-xs sm:text-sm",
                  children: _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsxs("strong", {
                            children: [
                              ...
                              '" (',
                              Math.round(25.4 * i.minRequiredIDInches * 10) /
                                10,
                              "mm)",
                            ],
                          }),
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        "minimum" !== c.comparison &&
                          _jsxs("div", {
                            className:
                              "mt-3 p-2 bg-white dark:bg-gray-800 rounded text-xs text-gray-600 dark:text-gray-300",
                            children: [
                              ...
                              " cables is ",
                              _jsx("strong", {
                                children: c.necMinConduit?.trade,
                              }),
                              ".",
                              "oversized" === c.comparison &&
            ...
            !i.exceedsMaximum &&
              ...
              _jsxs("div", {
                className:
                  "bg-amber-50 dark:bg-amber-900/20 rounded-xl shadow-md dark:shadow-gray-950/20 p-4 sm:p-6 border border-amber-300",
                children: [
                  _jsxs("h2", {
                    className:
                      "text-lg sm:text-xl font-semibold text-amber-800 dark:text-amber-200 mb-4 flex items-center gap-2",
                      ...
                      children: [
                        ...
                        _jsxs("p", {
                          ...
                          children: [
                            "Upgrade to ",
                            _jsx("strong", {
                              children: i.safeJamConduit.trade,
                            }),
                            " EMT (ID: ",
                            i.safeJamConduit.id,
                            '") for a safe JAM ratio of ',
                  ...
                  i.multiConduitOptions.length > 0 &&
                    _jsxs("div", {
                      className:
                        "p-3 sm:p-4 bg-white dark:bg-gray-800 rounded-lg border border-amber-200 dark:border-amber-800",
                      children: [
                        _jsx("h3", {
            ...
            !i.exceedsMaximum &&
              ...
              _jsxs("div", {
                className:
                  "bg-green-50 dark:bg-green-900/20 rounded-xl shadow-md dark:shadow-gray-950/20 p-4 sm:p-6 border border-green-300",
                children: [
                  _jsxs("h2", {
                    className:
            ...
            _jsxs("div", {
              ...
              children: [
                ...
                _jsxs("div", {
                  className:
                    "grid grid-cols-3 gap-2 sm:gap-3 text-xs sm:text-sm mb-4",
                  children: [
                    _jsxs("div", {
                      className:
            ...
            _jsxs("div", {
              ...
              children: [
                  ...
                  children: [
                    ...
                    i.exceedsMaximum &&
                      _jsx("span", {
                        ...
                        children:
                          "(All sizes exceeded - multiple conduits required)",
                      }),
                    !i.exceedsMaximum &&
                      c &&
                      c.conduit &&
                      ...
                      _jsx("tbody", {
                        children: i._0xf639dc.map((e, t) => {
                          const s = e.id / i.outerDiameterInches,
                            ...
                            o =
                              !i.exceedsMaximum &&
                              c?.conduit?.trade === e.trade,
                            d =
                              !i.exceedsMaximum &&
                              i.safeJamConduit?.trade === e.trade;
                          let m =
                            i.cableQty < 3
                              ? "N/A"
                              : s < 2.8
                ...
                _jsxs("div", {
                  className:
                    "flex flex-wrap gap-4 mt-3 text-xs text-gray-500 dark:text-gray-400",
                  children: [
                    _jsxs("span", {
                      children: [
                      ...
                      children: [
                        _jsxs("span", {
                          ...
                          children: [
                            _jsx("span", {
                              className:
                                "w-3 h-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded",
                            }),
                            " All Exceeded",
                          ],
                        }),
      ...
      "datarate" === e &&
        _jsxs(_Fragment, {
          children: [
            _jsxs("div", {
              className:
                "bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-8 mb-8 border",
              children: [
                _jsx("h2", {
                  className: "text-lg font-semibold text-gray-800 mb-4",
                      ...
                      children: [
                        ...
                        _jsxs("select", {
                          ...
                          children: [
                            ...
                            _jsx("option", {
                              value: 6,
                              children: "6 (5.1 Surround)",
                            }),
                            _jsx("option", {
                              value: 8,
                              children: "8 (7.1 Surround)",
                            }),
                          ],
                        }),
                      ],
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            _jsx("input", {
                              ...
                              placeholder: "Min",
                              className:
                                "w-1/2 px-3 py-2 border rounded-lg dark:bg-gray-700 dark:text-white dark:border-gray-600",
                            }),
                            _jsx("input", {
                              type: "number",
                              min: "0",
            ...
            x &&
              _jsxs("div", {
                className:
                  "bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-8 border",
                children: [
                  _jsx("h2", {
      ...
      "dante" === e &&
        _jsxs(_Fragment, {
          children: [
            _jsxs("div", {
              className:
                "bg-green-50 dark:bg-green-900/20 rounded-xl p-4 mb-6 border border-green-200 dark:border-green-800",
              children: [
                _jsx("h2", {
                  className:
                    "font-semibold text-green-800 dark:text-green-200 mb-2",
            ...
            w &&
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsxs("div", {
                    className:
                      "bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg border",
                    children: [
                      _jsxs("h3", {
                        className:
                          "font-semibold text-gray-700 dark:text-gray-300 mb-2",
                  ...
                  children: [
                    _jsxs("div", {
                      children: [
                        ...
                        _jsx("div", {
                          className: "flex flex-wrap gap-2 mt-2",
                          children: [50, 100, 250, 500, 1e3, 2e3, 4e3, 8e3].map(
                            (e) =>
                              _jsxs(
                                "button",
                                {
                      ...
                      children: [
                        ...
                        _jsx("p", {
                          className:
                            "text-xs text-gray-500 dark:text-gray-400 mt-1",
                          children:
                            "Temperature affects speed of sound (typical: 20°C)",
                        }),
                      ],
                    }),
                    _jsxs("div", {
                ...
                _jsx("button", {
                  ...
                  onClick: () => {
                    ...
                    [
                      ...
                      const t = Math.sqrt(
                        Math.pow(v - e.w, 2) + Math.pow(N - e.l, 2),
                      );
                      (t < 0.3
                        ? (w = "good")
                        : t < 0.5 && "good" !== w && (w = "acceptable"),
                    ...
                    for (let e = 0; e < K.length - 1; e++)
                      Math.abs(K[e] - K[e + 1]) <= 5 &&
                        Y.push(Math.round((K[e] + K[e + 1]) / 2));
                    if (
                      ("sub-bass" === z
                        ? (O.push({
                            type: "critical",
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  U.purposeInfo &&
                    _jsxs("div", {
                      className:
                        "mb-6 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800",
                      children: [
                        _jsxs("h3", {
                          className:
                  ...
                  _jsxs("div", {
                    className:
                      "mb-6 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border",
                    children: [
                      _jsx("h3", {
                        className:
                      ...
                      _jsx("div", {
                        className:
                          "bg-white dark:bg-gray-800 rounded-lg border p-2 sm:p-4 overflow-hidden",
                        children: (() => {
                          const e =
                      ...
                      _jsxs("div", {
                        className:
                          "mt-3 grid grid-cols-2 sm:grid-cols-4 gap-2 text-xs",
                        children: [
                          _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          _jsxs("div", {
                            className:
                              "bg-gray-50 dark:bg-gray-900/50 p-3 rounded-lg border",
                            children: [
                              _jsx("h4", {
                                className:
                                  "font-medium text-gray-700 dark:text-gray-300 mb-2",
                  ...
                  U.treatmentRec.length > 0 &&
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsxs("div", {
                          className:
                            "mt-4 p-3 bg-gray-100 dark:bg-gray-700 rounded-lg text-xs text-gray-600 dark:text-gray-300",
                          children: [
                            _jsx("strong", {
                              children: "Standards Reference: ",
                            }),
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      _jsx("input", {
                        ...
                        onChange: g(t),
                        className:
                          "w-full px-4 py-2 border rounded-lg text-lg font-medium dark:bg-gray-700 dark:text-white dark:border-gray-600",
                        placeholder: "0",
                      }),
                      _jsxs("span", {
                        className:
              ...
              _jsxs("div", {
                children: [
                  ...
                  _jsx("p", {
                    className: "text-xs text-gray-500 dark:text-gray-400 mt-1",
                    children:
                      "Video conferencing, multi-radio APs, small displays",
                  }),
                ],
              }),
              _jsxs("div", {
                children: [
                  ...
                  _jsx("p", {
                    className: "text-xs text-gray-500 dark:text-gray-400 mt-1",
                    children:
                      "Large displays, thin clients, high-power devices",
                  }),
                ],
              }),
            ],
          ...
          _jsx("div", {
            className:
              "mt-6 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border",
            children: _jsxs("div", {
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("p", {
                className: "text-xs text-gray-500 dark:text-gray-400 mt-1",
                children:
                  "Additional power buffer for future expansion and safety margin",
              }),
            ],
          }),
          _jsxs("div", {
            className:
              "mt-6 p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800",
            children: [
              _jsxs("label", {
                className:
                  "block text-sm font-medium text-orange-800 dark:text-orange-200 mb-2",
          ...
          _jsxs("div", {
            className:
              "mt-6 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800",
            children: [
              _jsx("label", {
                className:
                  "block text-sm font-medium text-purple-800 dark:text-purple-200 mb-3",
                    ...
                    children: [
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("input", {
                            ...
                            className:
                              "w-24 px-3 py-2 border rounded-lg text-lg font-medium dark:bg-gray-700 dark:text-white dark:border-gray-600",
                          }),
                          _jsxs("select", {
                            value: lengthUnit,
                            onChange: (ev) => {
                              ...
                              if (newUnit !== lengthUnit) {
                                ...
                                if (newUnit === "ft") {
                                  setCableLength(
                                    Math.round(cableLength * 3.28084),
                                  );
                                } else {
                                  setCableLength(
                                    Math.round(cableLength / 3.28084),
                            ...
                            className:
                              "px-3 py-2 border rounded-lg bg-white dark:bg-gray-800 dark:text-white dark:border-gray-600",
                            children: [
                              _jsx("option", {
                                value: "m",
                                children: "meters",
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("button", {
                            onClick: () => {
                              setCableLength(lengthUnit === "m" ? 30 : 98);
                            },
                            className:
                              "px-3 py-1 text-xs rounded-full border border-purple-300 hover:bg-purple-100 transition-colors " +
                              ((lengthUnit === "m" && cableLength === 30) ||
                              (lengthUnit === "ft" && cableLength === 98)
                                ? "bg-purple-200"
                                : "bg-white dark:bg-gray-800"),
                            children: "30m / 98ft",
                          }),
                          _jsx("button", {
                            onClick: () => {
                              setCableLength(lengthUnit === "m" ? 50 : 164);
                            },
                            className:
                              "px-3 py-1 text-xs rounded-full border border-purple-300 hover:bg-purple-100 transition-colors " +
                              ((lengthUnit === "m" && cableLength === 50) ||
                              (lengthUnit === "ft" && cableLength === 164)
                                ? "bg-purple-200"
                                : "bg-white dark:bg-gray-800"),
                            children: "50m / 164ft",
                          }),
                          _jsx("button", {
                            onClick: () => {
                              setCableLength(lengthUnit === "m" ? 75 : 246);
                            },
                            className:
                              "px-3 py-1 text-xs rounded-full border border-purple-300 hover:bg-purple-100 transition-colors " +
                              ((lengthUnit === "m" && cableLength === 75) ||
                              (lengthUnit === "ft" && cableLength === 246)
                                ? "bg-purple-200"
                                : "bg-white dark:bg-gray-800"),
                            children: "75m / 246ft",
                          }),
                          _jsx("button", {
                            onClick: () => {
                              setCableLength(lengthUnit === "m" ? 100 : 328);
                            },
                            className:
                              "px-3 py-1 text-xs rounded-full border border-purple-300 hover:bg-purple-100 transition-colors " +
                              ((lengthUnit === "m" && cableLength === 100) ||
                              (lengthUnit === "ft" && cableLength === 328)
                                ? "bg-purple-200"
                                : "bg-white dark:bg-gray-800"),
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsx("label", {
                    className:
                      "text-sm font-medium text-purple-800 dark:text-purple-200",
                    children: "Cable Type:",
                  }),
                  _jsxs("select", {
                    value: cableType,
                    ...
                    children: [
                      _jsx("option", {
                        value: "cat5e",
                        children: "Cat5e (24 AWG)",
                      }),
                      _jsx("option", {
                        value: "cat6",
                        children: "Cat6 (23 AWG)",
                      }),
                      _jsx("option", {
                        value: "cat6a",
                        children: "Cat6A (22 AWG)",
                      }),
                    ],
                  }),
                ],
          ...
          _jsx("button", {
            ...
            onClick: () =>
              u(
                _0x78d92f(
                  { poe: e, poePlus: s, poePlusPlus: r, fourPPOE: i },
                  o,
                  c,
                  cableLengthM,
                  cableType,
          ...
          children: [
            ...
            _jsxs("div", {
              ...
              children: [
                _jsxs("div", {
                  className:
                    "bg-blue-50 dark:bg-blue-900/20 p-5 rounded-lg border-2 border-blue-200 dark:border-blue-800",
                  children: [
                    _jsx("div", {
                      className: "text-sm text-gray-600 dark:text-gray-300",
                ...
                _jsxs("div", {
                  className:
                    "bg-orange-50 dark:bg-orange-900/20 p-5 rounded-lg border-2 border-orange-200 dark:border-orange-800",
                  children: [
                    _jsx("div", {
                      className: "text-sm text-gray-600 dark:text-gray-300",
                ...
                _jsxs("div", {
                  className:
                    "bg-purple-50 dark:bg-purple-900/20 p-5 rounded-lg border-2 border-purple-200 dark:border-purple-800",
                  children: [
                    _jsx("div", {
                      className: "text-sm text-gray-600 dark:text-gray-300",
                ...
                _jsxs("div", {
                  className:
                    "bg-green-50 dark:bg-green-900/20 p-5 rounded-lg border-2 border-green-200 dark:border-green-800",
                  children: [
                    _jsx("div", {
                      className: "text-sm text-gray-600 dark:text-gray-300",
            ...
            x.cableLoss &&
              x.cableLoss.totalLossWatts > 0 &&
              _jsxs("div", {
                className:
                  "bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-800 mb-6",
                children: [
                  _jsx("h3", {
                    className:
                      "text-sm font-semibold text-purple-800 dark:text-purple-200 mb-3",
                    children: "⚡ Cable Power Loss Analysis (IEEE 802.3)",
                  }),
                  _jsx("div", {
                    className:
                      "bg-white dark:bg-gray-800/80 rounded-lg p-3 mb-3 text-xs text-center",
                    children: _jsxs("div", {
                      className:
                      ...
                      children: [
                        ...
                        _jsxs("span", {
                          className:
                            "font-semibold " +
                            (x.cableLoss.lossPercent > 15
                              ? "text-red-600"
                              : x.cableLoss.lossPercent > 10
                                ? "text-orange-600"
                                : "text-green-600"),
                          children: [
                            "Cable Loss: ",
                            x.cableLoss.totalLossWatts,
                            "W",
                          ],
                        }),
                        _jsx("span", {
                        ...
                        _jsxs("span", {
                          className:
                            "font-bold text-green-700 bg-green-100 px-2 py-0.5 rounded",
                  ...
                  _jsxs("div", {
                    className:
                      "grid grid-cols-2 md:grid-cols-4 gap-3 text-center mb-3",
                    children: [
                      _jsxs("div", {
                        className:
                          "bg-white dark:bg-gray-800 p-3 rounded-lg shadow-sm dark:shadow-gray-950/10",
                        children: [
                          _jsxs("div", {
                            className: "text-xl font-bold text-purple-600",
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      _jsx("div", {
                        className:
                          "text-xs font-medium text-purple-800 dark:text-purple-200 mb-2",
                        ...
                        children: [
                          _jsxs("div", {
                            ...
                            children: [
                              _jsx("span", {
                                className: "text-gray-600 dark:text-gray-300",
                                children: "PoE (802.3af):",
                              }),
                              _jsxs("span", {
                                className: "font-medium",
                                children: [
                                  x.cableLoss.perType.poe.lossWatts,
                                  "W (",
                                  x.cableLoss.perType.poe.lossPercent,
                                  "%)",
                                ],
                              }),
                            ],
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              _jsx("span", {
                                className: "text-gray-600 dark:text-gray-300",
                                children: "PoE+ (802.3at):",
                              }),
                              _jsxs("span", {
                                className: "font-medium",
                                children: [
                                  x.cableLoss.perType.poePlus.lossWatts,
                                  "W (",
                                  x.cableLoss.perType.poePlus.lossPercent,
                                  "%)",
                                ],
                              }),
                            ],
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              ...
                              _jsxs("span", {
                                className: "font-medium",
                                children: [
                                  x.cableLoss.perType.poePlusPlus.lossWatts,
                                  "W (",
                                  x.cableLoss.perType.poePlusPlus.lossPercent,
                                  "%)",
                                ],
                              }),
                            ],
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              ...
                              _jsxs("span", {
                                className: "font-medium",
                                children: [
                                  x.cableLoss.perType.fourPPOE.lossWatts,
                                  "W (",
                                  x.cableLoss.perType.fourPPOE.lossPercent,
                                  "%)",
                                ],
                              }),
                            ],
            ...
            _jsxs("div", {
              ...
              children: [
                _jsxs("div", {
                  className:
                    "bg-gray-50 dark:bg-gray-900/50 p-5 rounded-lg border",
                  children: [
                    _jsx("div", {
                      className: "text-sm text-gray-600 dark:text-gray-300",
            ...
            _jsxs("div", {
              className:
                "bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-700 p-4 rounded-lg border-2 border-gray-300 dark:border-gray-600 mb-6",
              children: [
                _jsx("h3", {
                  className:
                    "text-sm font-semibold text-gray-700 dark:text-white mb-3",
              ...
              children: [
                _jsxs("div", {
                  ...
                  children: [
                    _jsx("div", {
                      className:
                        "text-sm font-medium text-orange-800 dark:text-orange-200 mb-1",
                      children: "🔌 UPS Sizing",
                    }),
                    _jsxs("div", {
            ...
            _jsxs("div", {
              className:
                "bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg border border-indigo-200 dark:border-indigo-800 mb-6",
              children: [
                _jsx("div", {
                  className:
                    "text-sm font-medium text-indigo-800 dark:text-indigo-200 mb-2",
                  children: "📋 Suggested Switch Brands",
                }),
                _jsx("div", {
                  className: "text-sm text-indigo-700",
                  children: x.recommendedBrands,
                }),
                _jsxs("div", {
                    ...
                    x.deviceCounts.poePlus > 0 &&
                      _jsxs("p", {
                        children: [
                          ...
                          " × 30W): ",
                          _jsxs("strong", {
                            children: [x.breakdown.poePlus, "W"],
                          }),
                        ],
                      }),
                    x.deviceCounts.poePlusPlus > 0 &&
                      _jsxs("p", {
                        children: [
                          ...
                          " × 60W): ",
                          _jsxs("strong", {
                            children: [x.breakdown.poePlusPlus, "W"],
                          }),
                        ],
                      }),
                    x.deviceCounts.fourPPOE > 0 &&
                      _jsxs("p", {
                        children: [
                          ...
                          " × 90W): ",
                          _jsxs("strong", {
                            children: [x.breakdown.fourPPOE, "W"],
                          }),
                        ],
                      }),
    ...
    children: [
        ...
        children: [
          ...
          _jsxs("div", {
            ...
            children: [
              _jsxs("div", {
                className:
                  "bg-white dark:bg-gray-800 p-2 rounded border border-blue-200 dark:border-blue-800 text-center",
                children: [
                  _jsx("div", {
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsx("div", {
                    className: "font-bold text-blue-700",
                    children: "12,000 BTU/hr",
                  }),
                  _jsx("div", {
                    className: "text-blue-600",
                    children: "= 1 Ton Cooling",
                  }),
                ],
              }),
            ],
      ...
      _jsxs("div", {
        ...
        children: [
          ...
          _jsxs("div", {
            className:
              "bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-6 border border-blue-200 dark:border-blue-800",
            children: [
              _jsx("h3", {
                className:
                  "text-sm font-semibold text-blue-800 dark:text-blue-200 mb-2",
              ...
              _jsxs("div", {
                children: [
                  ...
                  _jsx("p", {
                    className: "text-xs text-gray-500 dark:text-gray-400 mt-1",
                    children:
                      "ASHRAE: 400 BTU/hr per person (sedentary office work)",
                  }),
                ],
              }),
              _jsxs("div", {
                children: [
                  ...
                  _jsxs("div", {
                    className:
                      "mt-2 p-2 bg-yellow-50 dark:bg-yellow-900/20 rounded border border-yellow-200 dark:border-yellow-800",
                    children: [
                      _jsx("p", {
                        className:
                          "text-xs text-yellow-800 dark:text-yellow-200 font-medium mb-1",
                ...
                children: [
                  ...
                  _jsxs("select", {
                    ...
                    children: [
                      _jsx("option", {
                        value: 1,
                        children: "1.0× (No margin)",
                      }),
                      _jsx("option", {
                        value: 1.15,
                        children: "1.15× (15% margin)",
                      }),
                      _jsx("option", {
                        value: 1.25,
                  ...
                  _jsx("p", {
                    className: "text-xs text-gray-500 dark:text-gray-400 mt-1",
                    children:
                      "HVAC consultants typically recommend 1.25-1.5× for growth",
                  }),
                ],
              }),
            ],
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsxs("div", {
                className:
                  "mt-3 p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700",
                children: [
                  _jsxs("div", {
        ...
        _jsxs("div", {
          ...
          children: [
              ...
              children: [
                ...
                _jsxs("div", {
                  ...
                  children: [
                    _jsxs("div", {
                      className:
                        "bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border-2 border-blue-300 text-center",
                      children: [
                        _jsx("div", {
                          ...
                          children: [
                            ...
                            _jsxs("span", {
                              className:
                                "font-bold text-gray-700 dark:text-gray-300",
                              children: [
                                g.equipmentWatts.toLocaleString(),
                                " W",
                              ],
                            }),
                          ],
                ...
                _jsxs("div", {
                  className:
                    "p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg mb-4",
                  children: [
                    _jsx("h3", {
                      className:
                ...
                _jsx("div", {
                  className:
                    "p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg text-sm",
                  children: _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        children: [
                          ...
                          " ",
                          _jsxs("strong", {
                            children: [g.actualCFM, " (at 400 CFM/ton)"],
                          }),
                        ],
                      }),
                    ],
            ...
            g.warnings.length > 0 &&
              _jsxs("div", {
                className:
                  "bg-red-50 dark:bg-red-900/20 rounded-xl shadow-md dark:shadow-gray-950/20 p-4 sm:p-6 border border-red-300",
                children: [
                  _jsxs("h2", {
                    className:
                      "text-lg font-semibold text-red-800 dark:text-red-200 mb-3 flex items-center gap-2",
...
function SpeakerCalculator() {
  const [e, t] = useState(75),
    ...
    D = (e) => {
      ...
      (t !== e &&
        ("ft" === t && "m" === e
          ? (u((e) => Math.round(e * r * 100) / 100),
            p((e) => Math.round(e * r * 100) / 100))
          : "m" === t &&
            "ft" === e &&
            (u((e) => Math.round(e * l * 100) / 100),
            p((e) => Math.round(e * l * 100) / 100)),
        _(e)),
        s !== e &&
          ("ft" === s && "m" === e
            ? (N((e) => Math.round(e * r * 100) / 100),
              C((e) => Math.round(e * r * 100) / 100))
            : "m" === s &&
              "ft" === e &&
              (N((e) => Math.round(e * l * 100) / 100),
              C((e) => Math.round(e * l * 100) / 100)),
          k(e)),
        a !== e &&
          ("ft" === a && "m" === e
            ? n((e) => Math.round(e * r * 100) / 100)
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("h2", {
            className:
              "text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2",
            children: [
            ...
            children: [
              _jsxs("p", {
                ...
                children: [
                  ...
                  " EPR = 10",
                  _jsx("sup", {
                    children: "((Lp + H - Ls + 20×log₁₀(D/1m)) / 10)",
                  }),
                  " × 1W",
                ],
              }),
              ...
              _jsxs("div", {
                children: [
                  ...
                  _jsx("p", {
                    className: "text-xs text-gray-500 dark:text-gray-400 mt-1",
                    children:
                      "Lp in AVIXA formula - desired sound level at listener position",
                  }),
                  _jsx("div", {
                    className: "flex flex-wrap gap-2 mt-2",
                    children: [
                ...
                children: [
                  ...
                  _jsxs("select", {
                    ...
                    children: [
                      _jsx("option", {
                        value: "6",
                        children: "6 dB (Paging Only)",
                      }),
                      _jsx("option", {
                        value: "10",
                        children: "10 dB (Speech / Paging)",
                      }),
                      _jsx("option", {
                        value: "15",
                        children: "15 dB (Speech + Music)",
                      }),
                      _jsx("option", {
                        value: "20",
                        children: "20 dB (Background Music)",
                      }),
                      _jsx("option", {
                        value: "25",
                        children: "25 dB (Foreground Music)",
                      }),
                      _jsx("option", {
                        value: "40",
                        children: "40 dB (Live Performance)",
                      }),
                    ],
                  }),
                  _jsx("p", {
          ...
          _jsxs("div", {
            className:
              "mt-6 p-4 bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900/20 dark:to-green-900/20 rounded-lg border border-blue-200 dark:border-blue-800",
            children: [
              _jsx("h3", {
                className: "text-sm font-semibold text-gray-800 mb-3",
                children:
                  "📊 Target SPL Reference Guide (AVIXA/Industry Standards)",
              }),
              _jsx("p", {
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsxs("div", {
                    className:
                      "bg-white dark:bg-gray-800 p-3 rounded-lg border border-green-200 dark:border-green-800",
                    children: [
                      _jsxs("h4", {
                        className:
                      ...
                      _jsxs("ul", {
                        className:
                          "text-xs text-gray-600 dark:text-gray-300 space-y-1",
                        children: [
                          _jsxs("li", {
                            children: [
                  ...
                  _jsxs("div", {
                    className:
                      "bg-white dark:bg-gray-800 p-3 rounded-lg border border-blue-200 dark:border-blue-800",
                    children: [
                      _jsxs("h4", {
                        className:
                  ...
                  _jsxs("div", {
                    className:
                      "bg-white dark:bg-gray-800 p-3 rounded-lg border border-yellow-200 dark:border-yellow-800",
                    children: [
                      _jsxs("h4", {
                        className:
                  ...
                  _jsxs("div", {
                    className:
                      "bg-white dark:bg-gray-800 p-3 rounded-lg border border-red-200 dark:border-red-800",
                    children: [
                      _jsxs("h4", {
                        className:
              ...
              _jsx("div", {
                className:
                  "mt-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800",
                children: _jsxs("p", {
        ...
        children: [
          ...
          c &&
            _jsxs(_Fragment, {
              children: [
                        ...
                        _jsxs("select", {
                          ...
                          children: [
                            _jsx("option", {
                              value: "edge",
                              children:
                                "Edge-to-Edge (1.0D) - Minimum speakers",
                            }),
                            _jsx("option", {
                              value: "minimal",
                              children:
                                "Partial Overlap (0.75D) - Good uniformity ★",
                            }),
                            _jsx("option", {
                              value: "center",
                              children:
                                "Edge-to-Center (0.52D) - Maximum uniformity",
                            }),
                          ],
                        }),
                        _jsx("p", {
                  ...
                  children: [
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx("div", {
                          className:
                            "text-xs text-orange-600 text-center font-medium",
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx("div", {
                          className:
                            "text-xs text-blue-600 text-center font-medium",
                ...
                _jsxs("div", {
                  className:
                    "mt-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800",
                  children: [
                    _jsxs("h3", {
                      className:
          ...
          !c &&
            _jsx("p", {
              ...
              children:
                "Enable the checkbox above to calculate ceiling speaker coverage and spacing.",
            }),
        ],
      }),
      _jsx("button", {
        onClick: () => {
            ...
            switch (f) {
              case "edge":
                ((o = i),
                  (d = "Edge to Edge"),
                  (c =
                    "Coverage circles touch at edges (±4.4dB). Suitable for BGM/paging only."),
                  (m = "±4.4 dB"));
                break;
              case "minimal":
              default:
                ((o = n * Math.sqrt(2)),
                  (d = "Minimum Overlap"),
                  (c =
                    "AVIXA recommended (~29% overlap, ±2dB). Best balance of coverage and cost."),
                  (m = "±2.0 dB"));
                break;
              case "center":
                ((o = n),
          ...
          if (c && v > 0 && w > 0) {
            ...
            ("edge" !== f &&
              ...
              y.sort((e, t) =>
                e.isSelected ? -1 : t.isSelected ? 1 : e.total - t.total,
              ));
            const T = M !== j,
              L = s / d,
            ...
            Q =
              "edge" === f
                ? {
                    verdict:
                      V < 0 ? "Coverage gaps likely" : "Minimal redundancy",
                    consideration:
            ...
            const Y =
                "m" === j ? p.effectiveHeight : 0.3048 * p.effectiveHeight,
            ...
            (Z > 14
              ...
              : Z > 11
                ? (ee = {
                    ...
                    recommendation:
                      "Ensure adequate amplifier headroom for speech applications.",
                  })
                : Z > 8 &&
                  (ee = {
                    level: "normal",
              ...
              children: [
                ...
                _jsxs("div", {
                  ...
                  children: [
                    _jsxs("div", {
                      className:
                        "bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border-2 border-blue-200 dark:border-blue-800",
                      children: [
                        _jsx("div", {
                          className: "text-sm text-gray-600 dark:text-gray-300",
                    ...
                    _jsxs("div", {
                      className:
                        "bg-gray-50 dark:bg-gray-900/50 p-6 rounded-lg border",
                      children: [
                        _jsx("div", {
                          className:
                        ...
                        _jsxs("div", {
                          className:
                            "text-xs text-gray-600 dark:text-gray-300 space-y-2 font-mono",
                          children: [
                            _jsxs("p", {
                              children: [
                                "Target SPL (Lp): ",
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsx("h3", {
                    className: "text-lg font-semibold text-gray-800 mb-4",
                    children:
                      "Ceiling Speaker Layout Results (AVIXA Standards)",
                  }),
                  S.ceilingCalcs.effectiveHeightWarning &&
                    _jsxs("div", {
                      className:
                        "mb-4 p-4 bg-red-50 dark:bg-red-900/20 border-2 border-red-300 rounded-lg",
                      children: [
                        _jsx("div", {
                          className:
                            "font-semibold text-red-700 flex items-center gap-2",
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      _jsxs("div", {
                        className:
                          "bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg border-2 border-purple-200 dark:border-purple-800",
                        children: [
                          _jsx("div", {
                            className:
                              "text-sm text-gray-600 dark:text-gray-300",
                      ...
                      _jsxs("div", {
                        className:
                          "bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-lg border-2 border-indigo-200 dark:border-indigo-800",
                        children: [
                          _jsx("div", {
                            className:
                              "text-sm text-gray-600 dark:text-gray-300",
                      ...
                      _jsxs("div", {
                        className:
                          "bg-pink-50 p-6 rounded-lg border-2 border-pink-200",
                        children: [
                          _jsx("div", {
                            className:
                              "text-sm text-gray-600 dark:text-gray-300",
                  ...
                  _jsxs("div", {
                    className:
                      "bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg mb-6",
                    children: [
                      _jsx("h4", {
                        className:
                          "font-semibold text-gray-700 dark:text-gray-300 mb-3",
                  ...
                  _jsxs("div", {
                    className:
                      "p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg overflow-hidden",
                    children: [
                      _jsx("h4", {
                        className:
                          "font-semibold text-gray-700 dark:text-gray-300 mb-3",
                      ...
                      _jsxs("div", {
                        className:
                          "mt-3 pt-3 border-t border-gray-200 dark:border-gray-700 space-y-2",
                        children: [
                          _jsxs("p", {
                            className:
                              "text-xs text-gray-500 dark:text-gray-300",
                ...
                children: [
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        className:
                          "bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border-2 border-green-300",
                        children: [
                          _jsx("div", {
                      ...
                      _jsxs("div", {
                        className:
                          "bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border",
                        children: [
                          _jsx("div", {
                            className:
                              "text-sm text-gray-600 dark:text-gray-300",
                      ...
                      _jsxs("div", {
                        className:
                          "bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg border",
                        children: [
                          _jsx("div", {
                            className:
                              "text-sm text-gray-600 dark:text-gray-300",
                          ...
                          _jsxs("div", {
                            ...
                            children: [
                              S.roomRecommendation.coveragePercent,
                              "%",
                            ],
                          }),
                          _jsx("div", {
                  ...
                  _jsxs("div", {
                    className:
                      "p-3 sm:p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800",
                    children: [
                      _jsxs("h4", {
                        className:
                      ...
                      _jsx("div", {
                        className:
                          "bg-white dark:bg-gray-800 p-2 sm:p-4 rounded border overflow-x-auto",
                        children: (() => {
                            ...
                            children: [
                              _jsxs("div", {
                                ...
                                children: [
                                  _jsx("span", {
                                    ...
                                    children:
                                      S.roomRecommendation.densityRating,
                                  }),
                                  _jsxs("span", {
                                    className:
                                      "text-sm text-gray-600 dark:text-gray-300",
                              ...
                              _jsxs("div", {
                                ...
                                children: [
                                  ...
                                  S.roomRecommendation.patternRecommendation
                                    .verdict,
                                ],
                              }),
                            ],
                          ...
                          _jsxs("div", {
                            children: [
                              ...
                              _jsx("div", {
                                ...
                                children:
                                  S.roomRecommendation.suitableApplications.map(
                                    (e, t) =>
                                      _jsx(
                                        "span",
                                        {
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                                  ...
                                  className:
                                    ...
                                    S.roomRecommendation.splWarning.level
                                      ...
                                      : "moderate" ===
                                        ...
                                        : "text-green-700"),
                                  children:
                                    S.roomRecommendation.splWarning.title,
                                }),
                                _jsxs("span", {
                                  className:
                            ...
                            S.roomRecommendation.splWarning.recommendation &&
                              _jsx("p", {
                                className:
                                  "text-sm text-gray-600 dark:text-gray-300 mt-2 font-medium",
                                children:
                                  S.roomRecommendation.splWarning
                                    .recommendation,
                              }),
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("p", {
                    className: "text-sm text-gray-600 dark:text-gray-300 mb-4",
                    children:
                      "Based on the recommended speaker count and EPR calculation above.",
                  }),
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        className:
                          "bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border-2 border-blue-200 dark:border-blue-800",
                        children: [
                          _jsx("div", {
                            className:
                              "text-sm text-gray-600 dark:text-gray-300",
                          ...
                          _jsxs("div", {
                            className: "text-2xl font-bold text-blue-700",
                            children: [
                              S.amplifierCalcs.totalSpeakerPower,
                              " W",
                            ],
                          }),
                          _jsxs("div", {
                      ...
                      _jsxs("div", {
                        className:
                          "bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border-2 border-green-200 dark:border-green-800",
                        children: [
                          _jsx("div", {
                            className:
                              "text-sm text-gray-600 dark:text-gray-300",
                      ...
                      _jsxs("div", {
                        className:
                          "bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border-2 border-yellow-300",
                        children: [
                          _jsx("div", {
                            className:
                              "text-sm text-gray-600 dark:text-gray-300",
  ...
  const [e, t] = useState("metric"),
    ...
    l = (t) =>
      "" === t || null == t
        ? ""
        : "imperial" === e
          ? Math.round(10 * ((e) => 3.28084 * e)(t)) / 10
          : t,
    i = (t, s) => {
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("h1", {
            className: "text-3xl font-bold text-gray-900 dark:text-gray-100",
            children: "DSP System Calculator",
          }),
          ue !== null &&
            _jsx("button", {
              onClick: () => fe(!0),
      ...
      _jsx("p", {
        className: "text-gray-600 dark:text-gray-300 mb-4",
        children:
          "Professional DSP design tool based on AVIXA standards, IEC 60268, and industry practices",
      }),
      _jsx("div", {
        className:
          "bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 mb-6 border border-gray-200 dark:border-gray-700",
      ...
      _jsx("div", {
        className:
          "bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-4 mb-6 border border-blue-200 dark:border-blue-800",
        children: _jsxs("div", {
          ...
          children: [
            ...
            _jsxs("div", {
              ...
              children: [
                ...
                _jsx("div", {
                  className: "text-gray-600 dark:text-gray-300",
                  children: "≥ 20 dB (best practice)",
                }),
              ],
            }),
            _jsxs("div", {
              className:
                "bg-white dark:bg-gray-800 p-3 rounded-lg border border-purple-200 dark:border-purple-800",
              children: [
                _jsx("div", {
                  className:
                ...
                _jsx("div", {
                  className: "text-gray-600 dark:text-gray-300",
                  children: "< 20 ms (live sound)",
                }),
              ],
            }),
            _jsxs("div", {
              className:
                "bg-white dark:bg-gray-800 p-3 rounded-lg border border-orange-200 dark:border-orange-800",
              children: [
                _jsx("div", {
                  className:
          ...
          "input" === pe &&
            _jsxs("div", {
              children: [
                ...
                _jsx("div", {
                  className:
                    "mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg",
                  children: _jsxs("p", {
              ...
              children: [
                ...
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsxs("div", {
                      className:
                        "flex items-center gap-2 bg-gray-100 dark:bg-gray-700 px-3 py-2 rounded-lg",
                      children: [
                        _jsx("span", {
                          className:
                            "text-sm font-medium text-gray-700 dark:text-gray-300",
                ...
                "custom" !== s &&
                  _jsx("div", {
                    className:
                      "mb-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800",
                    children: _jsxs("p", {
                      className: "text-sm text-green-700",
                      children: [
                ...
                _jsxs("h3", {
                  className:
                    "text-md font-semibold text-gray-700 dark:text-gray-300 mb-3",
                  children: [
                    "Room Dimensions ",
                    "imperial" === e ? "(feet)" : "(meters)",
                  ],
                }),
                _jsxs("div", {
                  className:
                    "grid md:grid-cols-3 gap-4 mb-6 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg",
                  children: [
                    _jsxs("div", {
                      children: [
                        _jsxs("label", {
                ...
                _jsx("div", {
                  className:
                    "mt-4 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg",
                  children: _jsxs("p", {
            ...
            _jsxs("div", {
              children: [
                _jsxs("h2", {
                  ...
                  children: [
                    _jsx("span", { children: "🔊" }),
                    " PAG/NAG Feedback Analysis",
                  ],
                }),
                _jsx("div", {
                  className:
                    "bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mb-4 border border-blue-200 dark:border-blue-800",
                  children: _jsxs("p", {
                ...
                _jsx("div", {
                  className:
                    "mt-4 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800",
                  children: _jsxs("p", {
                    className: "text-xs text-orange-700",
                    children: [
                      _jsx("strong", {
                        children: "Feedback Stability Margin (FSM):",
                      }),
                ...
                _jsx("div", {
                  ...
                  children: [
                    ...
                    let t = e.mips,
                      ...
                      a = 0;
                    try {
                      const r = Object.values(le).reduce(
                          (e, t) => e + (Number(t) || 0),
                          0,
                        ),
                        l = Object.values(ne).reduce(
                          (e, t) => e + (Number(t) || 0),
                          0,
                        ),
                        i = r + l;
          ...
          "io" === pe &&
            _jsxs("div", {
              children: [
                  ...
                  children: [
                    _jsxs("div", {
                      children: [
                            ...
                            _jsxs("div", {
                              ...
                              children: [
                                ...
                                _jsx("input", {
                                  ...
                                  onChange: (e) =>
                                    ye("programAudio", e.target.value),
                                  className:
                                    "w-20 px-2 py-1 border rounded text-center",
                                }),
                              ],
                                  ...
                                  children: [
                                    ...
                                    _jsx("p", {
                                      className:
                                        "text-xs text-gray-500 dark:text-gray-300",
                                      children:
                                        "De-embedded from video sources",
                                    }),
                                  ],
                                }),
                                _jsx("input", {
                        ...
                        _jsxs("div", {
                          className:
                            "mt-3 p-2 bg-green-50 dark:bg-green-900/20 rounded text-sm text-green-700",
                          children: [
                            "Total Inputs: ",
                    ...
                    _jsxs("div", {
                      children: [
                            ...
                            _jsxs("div", {
                              ...
                              children: [
                                ...
                                _jsx("input", {
                                  ...
                                  onChange: (e) =>
                                    je("loudspeakers", e.target.value),
                                  className:
                                    "w-20 px-2 py-1 border rounded text-center",
                                }),
                              ],
                        ...
                        _jsxs("div", {
                          className:
                            "mt-3 p-2 bg-blue-50 dark:bg-blue-900/20 rounded text-sm text-blue-700",
                          children: [
                            "Total Outputs: ",
                ...
                _jsx("div", {
                  className:
                    "mt-4 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg",
                  children: _jsxs("p", {
                ...
                _jsx("div", {
                  className:
                    "mt-3 p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg border",
                  children: _jsxs("p", {
          ...
          "network" === pe &&
            _jsxs("div", {
              children: [
                ...
                _jsx("div", {
                  className:
                    "mt-4 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg",
                  children: _jsxs("p", {
                    className: "text-xs text-orange-700",
                    children: [
          ...
          children: [
            _jsxs("div", {
              ...
              children: [
                ...
                ue.errors &&
                  ...
                  _jsxs("div", {
                    className:
                      "mt-4 p-4 bg-red-100 rounded-lg border border-red-300",
                    children: [
                      _jsx("p", {
                        className:
                          "text-sm font-semibold text-red-800 dark:text-red-200 mb-3",
                      ...
                      _jsx("div", {
                        ...
                        children: ue.errors.map((e, t) => {
                          ...
                          return _jsxs(
                            ...
                            {
                              className:
                                "p-3 bg-white dark:bg-gray-800 rounded-lg border border-red-200 dark:border-red-800",
                              children: [
                                _jsxs("p", {
                                  className:
                                ...
                                _jsxs("div", {
                                  className:
                                    "mt-2 pl-3 border-l-2 border-red-300",
                                  children: [
                                    _jsxs("p", {
                                      className:
                          ...
                          return _jsxs(
                            "div",
                            {
                              ...
                              children: [
                                _jsxs("p", {
                                  className:
                                    "text-sm text-orange-800 dark:text-orange-200 font-medium",
                                  children: ["⚠️ ", e],
                                }),
                                _jsxs("div", {
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsxs("span", {
                              className: "font-bold truncate",
                              children: [
                                ue.gainStructure.inputHeadroomDb,
                                " dB",
                              ],
                            }),
                          ],
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsxs("span", {
                              className: "font-bold truncate",
                              children: [
                                ue.gainStructure.requiredInputGainDb,
                                " dB",
                              ],
                            }),
                          ],
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsx("div", {
                            className:
                              "pt-2 border-t text-xs text-gray-500 dark:text-gray-400",
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsxs("span", {
                              className: "font-bold truncate",
                              children: [
                                ue.splCalculation.distanceLossDb,
                                " dB",
                              ],
                            }),
                          ],
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsxs("span", {
                              className: "font-bold truncate",
                              children: [
                                ue.splCalculation.roomAbsorptionLossDb,
                                " dB",
                              ],
                            }),
                          ],
                              ...
                              className:
                                ...
                                (ue.noiseAndSensitivity.noiseFloorDba <= 35
                                  ...
                                  : ue.noiseAndSensitivity.noiseFloorDba <= 45
                                    ...
                                    : "text-red-600"),
                              children: [
                                ue.noiseAndSensitivity.noiseFloorDba,
                                " dBA",
                              ],
                            }),
                          ],
                          ...
                          children: [
                            ...
                            _jsx("span", {
                              className:
                                "text-xs font-medium " +
                                ("Excellent" ===
                                  ue.noiseAndSensitivity.snrRating ||
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsxs("span", {
                              className: "font-bold truncate",
                              children: [
                                ue.latency.breakdown.dspProcessingMs,
                                " ms",
                              ],
                            }),
                          ],
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsxs("span", {
                              className: "font-bold truncate",
                              children: [
                                ue.latency.breakdown.networkTransportMs,
                                " ms",
                              ],
                            }),
                          ],
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsxs("span", {
                              className: "font-bold text-lg truncate",
                              children: [
                                ue.networkAudio.totalBandwidthMbps,
                                " Mbps",
                              ],
                            }),
                          ],
            ...
            _jsxs("div", {
              ...
              children: [
                ...
                _jsxs("div", {
                  className:
                    "grid md:grid-cols-2 gap-4 text-xs font-mono text-gray-600 dark:text-gray-300",
                  children: [
                    _jsxs("div", {
                      children: [
            ...
            ue.actionItems &&
              ...
              _jsxs("div", {
                className:
                  "bg-white dark:bg-gray-800 rounded-xl p-6 border shadow-sm dark:shadow-gray-950/10",
                children: [
                  _jsx("h3", {
                    className:
                      ...
                      _jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            _jsx("p", {
                              className:
                                "text-sm text-gray-700 dark:text-gray-300 font-medium mb-2",
                              children: e.issue,
                            }),
                            _jsx("ul", {
                              className:
                                "text-sm text-gray-600 dark:text-gray-300 space-y-1 ml-4",
                              children: e.actions.map((e, t) =>
                                _jsxs(
                                  "li",
                                  { className: "list-disc", children: e },
                                  t,
                                ),
                              ),
                            }),
            ...
            ue.dspRecommendation &&
              _jsxs("div", {
                className:
                  "bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-xl p-6 border-2 border-purple-200 dark:border-purple-800 shadow-sm dark:shadow-gray-950/10",
                children: [
                  _jsxs("h3", {
                    className:
                      "text-xl font-bold text-purple-800 dark:text-purple-200 mb-4 flex items-center gap-2",
                    children: [
                      _jsx("span", { children: "🎛️" }),
                      " DSP Selection Recommendation",
                    ],
                  }),
                  _jsxs("div", {
                    className: "grid md:grid-cols-2 gap-6",
                            ...
                            children: [
                              ...
                              _jsx("p", {
                                className:
                                  "text-xs text-gray-500 dark:text-gray-400 mt-1",
                                children:
                                  ue.dspRecommendation.tierReason.join("; "),
                              }),
                            ],
                          }),
                          _jsxs("div", {
                            ...
                            children: [
                              ...
                              _jsx("div", {
                                ...
                                children:
                                  ue.dspRecommendation.featuresNeeded.map(
                                    (e, t) =>
                                      _jsx(
                                        "span",
                                        {
                              ...
                              _jsxs("p", {
                                children: [
                                  ...
                                  _jsx("span", {
                                    ...
                                    children:
                                      ue.dspRecommendation.roomSizeCategory,
                                  }),
                                ],
                              }),
                              _jsxs("p", {
                                children: [
                                  "I/O Count: ",
                                  ue.dspRecommendation.complexityFactors
                                    .ioCount,
                                  " channels",
                                ],
                              }),
                  ...
                  _jsxs("div", {
                    className:
                      "mt-4 p-3 bg-white dark:bg-gray-800/50 rounded-lg",
                    children: [
                      _jsxs("p", {
                        className:
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("p", {
                            className:
                              "text-xs font-semibold text-purple-700 mb-2",
                            children: "💡 DSP Selection Best Practices:",
                          }),
                          _jsxs("ul", {
                            className:
                              "text-xs text-gray-600 dark:text-gray-300 space-y-1 ml-4",
                            children: [
                              _jsx("li", {
                                className: "list-disc",
                                children:
...
function RackBuilderCalculator() {
  const [e, t] = useState([]),
    ...
    xe = [
      {
        bg: "bg-blue-50 dark:bg-blue-900/200",
      ...
      {
        bg: "bg-amber-50 dark:bg-amber-900/200",
  ...
  useEffect(() => {
    ...
    if (!pdfLogoCacheRef.current && !pdfLogoLoadingRef.current) {
      ...
      const logoUrl = "AV_TOOLS_LOGO.png";
      const img = new Image();
  ...
  const ge = ((e) => {
      ...
      const g =
        l.length +
        Object.values(o).reduce((e, t) => e + Math.ceil(t.length / 2), 0);
      return {
        effectiveRU: u + d + h + m,
    ...
    })(),
    {
      ...
      totalCapacity: je,
      blanksNeeded: _e,
      actualSparePercent: ve,
      needsMultipleRacks: Ne,
    } = fe,
    we = [...ye],
    ...
    ke =
      ...
      () => {
        ...
        e.forEach((e, t) => {
          s.push({
            ...e,
            colorIndex: t % xe.length,
            isHalfWidth: "half" === e.width,
          });
        });
        const r = we.length,
          l = c / 100,
  ...
  const Fe = [8, 12, 15, 18, 22, 25, 27, 32, 37, 42, 45],
    ...
    Le = (e, t) =>
      t <= 0 || e <= 0 ? 0 : t >= 100 ? 45 : Math.ceil((e * t) / (100 - t)),
    He = (e, t, s = 45) => {
    ...
    qe = (e, t, s, a = null) => {
      const r = ((e, t, s, a = null) => {
        for (let r = 0; r < e.length; r++) {
          ...
          if (n && !o && i.type === t && (i.ru || 1) === s)
            return { layoutIdx: r, item: l };
        }
        return null;
      })(e.layout, t, s, a);
      if (r)
    ...
    Oe = (e, t, s = 45) => {
      ...
      return e.map((e, r) => {
          ...
          layout: e.layout.map((e) =>
            "equipment" === e.type && e.item
              ? {
                  ...
                  item: {
                    ...e.item,
                    pairItem: e.item.pairItem ? { ...e.item.pairItem } : null,
                  },
                }
              : { ...e },
          ),
        ...
        for (let e = 0; e < n; e++)
          l.layout.length > 0 &&
            "blank" === l.layout[l.layout.length - 1].type &&
            l.layout.pop();
        for (let e = 0; e < p; e++)
          l.layout.push({
        ...
        l.layout.forEach((e) => {
          if ("equipment" === e.type && e.item) {
            ...
            "blank" === e.type && ((e.startRU = b), (e.endRU = b), b++, y++);
        });
        const j = f + y;
        return (
          (l.rackSize = Math.min(j, s)),
          (l.equipmentRU = f),
          (l.blanksRU = y),
          (l.rackIndex = r),
          l
    ...
    ze = (e, t, s = 45) => {
      ...
      Object.values(o).forEach((e) => {
        for (let t = 0; t < e.length; t += 2)
          t + 1 < e.length
            ? d.push({ item1: e[t], item2: e[t + 1] })
            : d.push({ item1: e[t], item2: null });
      });
      const c = [];
      (i.forEach((e) => {
        ...
        return (
          ...
          a.layout.forEach((e) => {
            if ("equipment" === e.type && e.item) {
              ...
              "blank" === e.type && ((e.startRU = n), (e.endRU = n), n++, l++);
          }),
    ...
    if (t !== Se.current) {
      if (((Se.current = t), e.length > 0)) {
        ...
        if (De.current && s.length > 0 && t.length > 0) {
          ...
          i.forEach((e) => {
            o.forEach((t, s) => {
              const a = t.layout.findIndex(
                (t) => "equipment" === t.type && t.item && t.item.id === e,
              );
              if (-1 !== a) {
                ...
                if ("equipment" === e.type && e.item) {
                  ...
                  if (s) {
                    ...
                    ((e.item.name = s.name),
                      ...
                      r &&
                        ((e.item.isHalfPair = !1), (e.item.pairItem = null)));
                    const l = !a,
                      i = "half" === s.width;
          ...
          for (
            ...
            if (o[o.length - 1].layout.some((e) => "equipment" === e.type))
              break;
            o.pop();
          }
          if (
            (((e) => {
              ...
              console.error(
                "ERROR: Mixed mount types detected in layout - this should not happen",
              ),
      ...
      if ("manual" !== L && c !== Re.current && e.length > 0)
        if (((Re.current = c), De.current && h.length > 0)) {
          ...
          if (
            ...
            let e = Oe(h, c, me);
            for (; e.length > 1; ) {
              if (e[e.length - 1].layout.some((e) => "equipment" === e.type))
                break;
              e.pop();
            }
            p(Xe(Ge(e, me), h));
  ...
  const Je = () => {
      ...
      if (
        (n > 20 &&
          console.warn(
            `Adding large equipment: ${n}U - may require special mounting considerations`,
          ),
        "manual" === L)
      ) {
        if (0 === h.length) {
      ...
      if (d > 337.5)
        return I(
          `Total equipment (${d}U) exceeds practical limit. Consider splitting into separate systems.`,
        );
      (t([
        ...e,
        {
              ...
              "equipment" === e.type && e.item && e.item.id === s
                ...
                : "equipment" === e.type &&
                  ...
                  ? {
                      ...
                      item: {
                        ...e.item,
                        pairItem: { ...e.item.pairItem, name: a.trim() },
                      },
                    }
                  : e,
            ),
      ...
      if (
        ...
        if (e && r > i) {
          ...
          if (o) {
            ...
            if (s < t)
              return void I(
                `Cannot increase size: need ${t}U of blank space, only ${s}U available.`,
              );
          }
        }
      }
    ...
    Ze = (e) => {
      ...
      if ("manual" === L) {
        ...
        if (r >= e)
          return void I(
            `Cannot add blank: Rack ${t + 1} is full (${e}U). Increase rack size first.`,
          );
      } else {
        if (r >= me)
          return void I("Cannot add blank: rack is at maximum size (45U)");
        if (r + 1 > me)
          return void I(
            "Cannot add blank: would exceed maximum rack size (45U)",
          );
      }
      const l = h.map((e) => ({
          ...e,
      ...
      if (o + d + 1 > c)
        return void I(`Cannot add blank: would exceed rack size (${c}U)`);
      const m = {
      ...
      if (x > me) {
        ...
        for (let t = i.layout.length - 1; t >= 0 && e > 0; t--)
          "blank" !== i.layout[t].type ||
            i.layout[t].isUserGap ||
            (i.layout.splice(t, 1), e--);
      }
      ...
      ((t = 0),
        ...
        e.layout.forEach((e) => {
          if ("equipment" === e.type && e.item) {
            ...
            "blank" === e.type && ((e.startRU = r), (e.endRU = r), r++, s++);
        }),
    ...
    it = (e, t, s) => {
      ...
      if ("string" == typeof r && r.endsWith(":pair")) {
        ...
        if (n >= 0 && i.layout[n].item && i.layout[n].item.pairItem) {
          const e = i.layout[n].item.pairItem,
            r = e.ru || 1;
          ((i.layout[n].item.isHalfPair = !1),
            (i.layout[n].item.pairItem = null));
          const l = {
            id: e.id,
            startRU: 0,
            endRU: 0,
          ...
          if (f.rackIdx === t) {
            ...
            if (o < r)
              return (
                I(
                  `Cannot move "${e.name}" (${r}U) to Rack ${t + 1}. Only ${o}U available.`,
                ),
                y(null),
                void _(null)
              );
      ...
      if (f.rackIdx === t) {
        ...
        if (r !== l) {
          ...
          ("blank" === t.type && (t.isUserGap = !0),
            e.layout.splice(l, 0, t),
            st(e));
        }
      } else {
        const e = a[f.rackIdx],
        ...
        if ("equipment" === l.type) {
          ...
          if (e < i) {
            ...
            return (
              I(
                `Cannot move "${s}" (${i}U) to Rack ${t + 1}. Only ${e}U available.`,
              ),
              y(null),
              void _(null)
            );
        ...
        if (
          ("blank" === o.type && (o.isUserGap = !0), "equipment" === l.type)
        ) {
          for (let t = 0; t < i; t++)
        ...
        ? (() => {
            ...
            (h.forEach((e) => {
              ...
              ge.ruSaved > 0 &&
                t.push({
                  type: "success",
                  text: `✅ Half-width pairing saves ${ge.ruSaved}U.`,
                }),
            ...
            if (
              ...
              const e = h
                ...
                .map(
                  (e) => `R${e.idx}: ${e.equipRU}/${e.rackSize}U (${e.spare}%)`,
                )
                .join(" • ");
            ...
            if (h.length > 0) {
              ...
              t.push({
                type: "info",
                text: `EIA-310: ${s}U blank panels for airflow management.`,
              });
              ...
              if (a)
                h.length > 1
                  ? t.push({
                      type: "success",
                      text: `✅ All ${h.length} racks maintain ≥${c}% spare.`,
                    })
                  : t.push({
                      type: "success",
                ...
                const e = r
                  .map((e) => `${e.shortName}: ${e.spare}%`)
                  .join(", ");
                t.push({
                  type: "warning",
                  text: `⚠️ Below ${c}% target: ${e}. Consider adding racks.`,
                });
              }
            }
            h.length > 5 &&
            ...
            return (
              be > 20 &&
                t.push({
                  type: "info",
                  text: `⚡ Estimated power: ~${l}W. Verify PDU capacity.`,
                }),
              d >= c
                ? t.push({
                    type: "success",
                    text: `✅ Overall: ${d}% spare (target: ${c}%).`,
                  })
                : t.push({
                    type: "warning",
                    text: `⚠️ Overall: ${d}% spare < ${c}% target.`,
                  }),
              t
            );
          })()
    ...
    dt = (e, t, s) => {
      ...
      return _jsxs("div", {
        key: t,
        className:
          "flex-shrink-0 flex flex-col " + (f ? "w-56" : "flex-1 max-w-md"),
        ...
        children: [
          _jsxs("div", {
            ...
            onClick: () => {
              (T(t),
                e.layout &&
                  e.layout.length > 0 &&
                  b({ rackIdx: t, layoutId: e.layout[0].id }));
            },
            children: [
              _jsxs("div", {
                ...
                children: [
                  _jsxs("div", {
                    ...
                    children: [
                      _jsx("div", {
                        className:
                          "rack-name-container flex-1 min-w-0 overflow-hidden",
                        children: _jsx("input", {
                          type: "text",
                          value: e.name || "",
          ...
          _jsxs("div", {
            ...
            children: [
              _jsx("div", {
                className:
                  "flex flex-col-reverse text-xs text-gray-400 w-6 pt-1 pb-1",
                children: Array.from({ length: n }, (e, t) => t + 1).map(
                  (e, t) =>
                    _jsx(
                      "div",
                      {
              ...
              _jsx("div", {
                className:
                  ...
                  (u
                    ? "border-yellow-400 shadow-lg dark:shadow-gray-950/30 shadow-yellow-200/50"
                    : "border-gray-700"),
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("h1", {
        className:
          "text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4",
        children: "Professional Rack Builder",
      }),
      _jsxs("div", {
        className:
          "bg-white dark:bg-gray-800 rounded-xl p-4 mb-4 border shadow-sm dark:shadow-gray-950/10",
        children: [
          _jsxs("div", {
          ...
          _jsx("div", {
            ...
            children: _jsxs("div", {
              className:
                "flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500 dark:text-gray-400",
              children:
                "auto" === L
                  ? [
                      _jsxs("span", {
      ...
      D &&
        _jsxs("div", {
          ...
          children: [
              ...
              children: [
                ...
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("div", {
                      className: "text-sm text-white/95 leading-snug",
                      children: D,
                    }),
                  ],
                }),
            ...
            _jsx("div", {
              className:
                "mt-2 h-1 bg-white dark:bg-gray-800/20 rounded-full overflow-hidden",
              children: _jsx("div", {
      ...
      _jsxs("div", {
        className:
          "bg-purple-50 dark:bg-purple-900/20 rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 border border-purple-200 dark:border-purple-800",
        children: [
          _jsx("h2", {
            className:
              "font-semibold text-purple-800 dark:text-purple-200 mb-2 text-sm sm:text-base",
          ...
          _jsxs("div", {
            ...
            children: [
              _jsxs("div", {
                className:
                  "bg-white dark:bg-gray-800 p-1.5 sm:p-2 rounded border text-center",
                children: [
                  _jsx("div", {
      ...
      _jsxs("div", {
        className:
          "bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-3 sm:p-4 mb-4 sm:mb-6 border",
        children: [
          _jsxs("div", {
            className: "flex items-center justify-between mb-2",
            children: [
            ...
            children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsxs("div", {
                    className:
                      "text-xs font-medium text-gray-700 dark:text-gray-300 mb-1.5 flex items-center gap-1",
                    children: [
                      _jsx("span", {
                        children: "Rack-Mounted" === e.category ? "🔧" : "📦",
                      }),
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              _jsxs("div", {
                className:
                  "bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-3 sm:p-4 border",
                children: [
                  _jsx("h2", {
                      ...
                      _jsxs("div", {
                        children: [
                          ...
                          _jsx("input", {
                            ...
                            className:
                              "w-full px-3 py-2.5 border rounded-lg text-sm dark:bg-gray-700 dark:text-white dark:border-gray-600",
                          }),
                        ],
                      }),
                      _jsxs("div", {
                            ...
                            _jsx("button", {
                              onClick: async () => {
                                ...
                                if (
                                  ...
                                  I(
                                    "Add equipment to your rack before exporting.",
                                  );
                              },
                              className:
                ...
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    _jsx("p", {
                      ...
                      children:
                        "Configure your rack size and add additional racks",
                    }),
                    h.length > 0 &&
                      _jsxs("div", {
                        className: "mb-3",
              ...
              (e.length > 0 || ("manual" === L && h.length > 0)) &&
                _jsxs("div", {
                  className:
                    "bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-4 border",
                  children: [
                    _jsx("h2", {
                    ...
                    _jsxs("div", {
                      className:
                        "p-3 bg-purple-100 rounded-lg border border-purple-300 mb-3",
                      children: [
                        _jsx("div", {
                          className: "text-xs text-purple-600",
                          children:
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        _jsxs("div", {
                          className:
                            "bg-blue-50 dark:bg-blue-900/20 p-2 rounded",
                          children: [
                            _jsx("div", {
                              className: "text-xs text-blue-600",
                              children: "Equipment",
                            ...
                            _jsxs("div", {
                              className:
                                "text-lg font-bold text-blue-800 dark:text-blue-200",
                              children: [
                                (() => {
                                  let e = 0;
                                  return (
                        ...
                        _jsxs("div", {
                          className:
                            "bg-orange-50 dark:bg-orange-900/20 p-2 rounded",
                          children: [
                            _jsx("div", {
                              className: "text-xs text-orange-600",
                              children: "Blanks",
                    ...
                    _jsxs("div", {
                      className:
                        "text-xs p-2 bg-gray-50 dark:bg-gray-900/50 rounded mb-3",
                      children: [
                        _jsx("div", {
          ...
          _jsxs("div", {
            className:
              "lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-950/20 p-3 sm:p-4 border",
            children: [
              _jsxs("div", {
                className:
                  "flex flex-col sm:flex-row sm:items-center justify-between mb-3 gap-2",
                children: [
                  _jsxs("h2", {
                    className: "text-base sm:text-lg font-semibold",
                    children: [
                      "🗄️ Rack Layout",
                      h.length > 1 ? ` (${h.length} Racks)` : "",
                    ],
                  }),
                  _jsxs("div", {
                    className: "flex items-center gap-2",
                    children: [
                      ...
                      _jsx("span", {
                        className: "text-xs text-gray-500 dark:text-gray-300",
                        children:
                          "Tap item to select • Use floating bar to edit",
                      }),
                    ],
                  }),
                ],
                ...
                ? _jsx("div", {
                    ...
                    children: _jsxs("div", {
                      ...
                      children: [
                        ...
                        _jsx("p", {
                          className:
                            "text-gray-600 dark:text-gray-300 font-medium mb-2",
                ...
                : 0 === e.length && "manual" !== L
                  ...
                  : _jsxs("div", {
                      children: [
                        _jsx("div", {
                          className:
                            "overflow-x-auto pb-4 -mx-3 px-3 sm:mx-0 sm:px-0",
                          children: (() => {
                            Math.max(
                              ...h.map((e) => {
                                const { totalRU: t } = Ue(e.layout);
                          ...
                          children: [
                            _jsxs("div", {
                              ...
                              children: [
                                _jsx("div", {
                                  className:
                                    "w-4 h-4 bg-blue-50 dark:bg-blue-900/200 rounded",
                                }),
                              ...
                              children: [
                                _jsxs("div", {
                                  ...
                                  children: [
                                    _jsx("div", {
                                      className:
                                        "w-2 h-4 bg-blue-50 dark:bg-blue-900/200 rounded-l",
                                    }),
                                    _jsx("div", {
                                      className:
                                        "w-2 h-4 bg-emerald-500 rounded-r",
                                    }),
                                  ],
                                }),
            ...
            children: _jsx("div", {
              ...
              children: _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("div", {
                    className:
                      "w-px h-5 sm:h-6 bg-gray-200 dark:bg-gray-700 mx-0.5 sm:mx-1",
                  }),
                  _jsx("button", {
                    onClick: () => {
                      if (!g) return;
                      ...
                      if (
                        (h.forEach((s, r) => {
                          ...
                          availableSpace >= t &&
                            a.push({
                              idx: r,
                              availableBlanks: availableSpace,
                              rack: s,
                            });
                        }),
                        0 === a.length)
                        ...
                        return _jsxs(_Fragment, {
                          children: [
                            ...
                            _jsx("span", {
                              ...
                              title:
                                "No other racks have enough space for this item",
                            ...
                            children: [
                              ...
                              _jsx("select", {
                                onChange: (e) => {
                                  ...
                                  let trailingCount = 0;
                                  for (
                                    let idx = d.layout.length - 1;
                                    idx >= 0 && d.layout[idx].type === "blank";
                                    idx--
                                  ) {
                                    trailingStart = idx;
                                    trailingCount++;
                                  ...
                                  d.layout.splice(
                                    blanksToRemove.start,
                                    blanksToRemove.count,
                                  );
                                ...
                                children: [
                                  ...
                                  ...a.map(
                                    ({ idx: e, availableBlanks: t, rack: s }) =>
                                      _jsx(
                                        "option",
                                        {
                                          value: String(e),
                  ...
                  _jsx("button", {
                    ...
                    children: _jsx("svg", {
                      className:
                        "w-4 h-4 sm:w-5 sm:h-5 text-gray-600 dark:text-gray-300 group-hover:text-red-500",
                      fill: "none",
                      viewBox: "0 0 24 24",
                      stroke: "currentColor",
                      strokeWidth: 2,
                  ...
                  _jsx("button", {
                    ...
                    children: _jsx("svg", {
                      className:
                        "w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-gray-600 dark:text-gray-300",
                      fill: "none",
                      viewBox: "0 0 24 24",
                      stroke: "currentColor",
                      strokeWidth: 2,
            ...
            children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsx("h3", {
                    className:
                      "text-xl font-bold text-gray-900 dark:text-gray-100 mb-3",
                    children: "Add New Rack",
                  }),
                  _jsx("p", {
                    className:
            ...
            children: [
              _jsxs("div", {
                ...
                children: [
                  _jsx("div", {
                    className:
                      "h-24 bg-gradient-to-br from-red-500 via-red-600 to-red-700",
                    style: { borderRadius: "0 0 50% 50% / 0 0 30px 30px" },
                  }),
                  _jsx("button", {
                    onClick: () => {
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("p", {
                    className:
                      "text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-6",
                      ...
                      _jsx("button", {
                        onClick: () => {
                          (((e) => {
                            if ("manual" !== L) return;
                            if (h.length <= 1)
                              return void I("Cannot remove the last rack");
                            const s = h[e];
                            if (s) {
                              const e = new Set();
                              (s.layout.forEach((t) => {
